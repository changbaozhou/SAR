...
class Cifar100:
    def __init__(self, args):
        ...
        train_set = torchvision.datasets.CIFAR100(root='/home/bobzhou/dataset', train=True, download=True, transform=train_transform) 
        test_set = torchvision.datasets.CIFAR100(root='/home/bobzhou/dataset', train=False, download=True, transform=test_transform) if args.local_rank in [-1, 0] else None
